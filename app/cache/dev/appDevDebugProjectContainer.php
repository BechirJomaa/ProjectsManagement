...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'gestionProjet', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\GestionBundle\\Entity'))), 'GestionBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('GestionBundle' => 'GestionBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c964b6ba99536488c44a5f35ffc09d297fe313a28ee98e15067e1bee5fb1f6f6');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('GestionBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('jomaa.bechir@gmail.com' => 'jomaa.bechir@gmail.com'), 'resetting' => array('jomaa.bechir@gmail.com' => 'jomaa.bechir@gmail.com'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('GestionBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('GestionBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('GestionBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('doctrine')->getManager(NULL), 'GestionBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/projet/new');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/materiel/new');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/projet');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/materiel');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/client');
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('maher.gafsi@esprit.tn');
        $a->setPassword(95333210);
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\GestionBundle/Resources/views'), 'Gestion');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GestionBundle' => 'GestionBundle\\GestionBundle',
            ...
            'mailer_user' => 'jomaa.bechir@gmail.com',
            'mailer_password' => 95333210,
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'maher.gafsi@esprit.tn',
            'swiftmailer.mailer.default.transport.smtp.password' => 95333210,
            ...
            'fos_user.model.user.class' => 'GestionBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'jomaa.bechir@gmail.com' => 'jomaa.bechir@gmail.com',
            ),
