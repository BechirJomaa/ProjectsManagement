 ...
 */
class User extends \GestionBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'GestionBundle\\Entity\\User' . "\0" . 'projects', '' . "\0" . 'GestionBundle\\Entity\\User' . "\0" . 'taches', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles');
        }
    ...
    public function addProjects(\GestionBundle\Entity\Projet $project)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addProjects', array($project));

        return parent::addProjects($project);
    }
    ...
    public function removeProjects(\GestionBundle\Entity\Projet $project)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeProjects', array($project));

        return parent::removeProjects($project);
    }
